...
value =('ansver', 42)	
s = str(value) #str(repr-ic igivea rac str, gansxvaveba: sxva pailshi weria) funqcia romelic s-s anichebs valueshi arsebul informacias miuxedavad gansxvavebuli cvladebis(simbolo da ricxvi) da xdeba stringi gaertianebuli mnishvnelobebi
